...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::mat& >::type init_u4(init_u4SEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type init_u5(init_u5SEXP);
    rcpp_result_gen = Rcpp::wrap(LA_ADMM_clusterglasso_export(it_out, it_in, S, A, Itilde, A_for_C3, A_for_T1, T2, T2_for_D, lambda1, lambda2, rho, pendiag, init_om, init_u1, init_u2, init_c, init_u3, init_u4, init_u5));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_clusterglasso_LA_ADMM_clusterglasso_export", (DL_FUNC) &_clusterglasso_LA_ADMM_clusterglasso_export, 20},
    {NULL, NULL, 0}
};
