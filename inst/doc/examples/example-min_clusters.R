...
# Compute the weight matrix for the clusterpath (clustering) weights without
...
# Compute the weight matrix for the clusterpath (clustering) weights with
# enforcing connectedness (default behavior)
