...
.cggm2 <- function(W_keys, W_values, Ri, Ai, pi, ui, S, lambdas, eps_fusions, gss_tol, conv_tol, max_iter, store_all_res, verbose) {
    .Call(`_CGGMR_cggm2`, W_keys, W_values, Ri, Ai, pi, ui, S, lambdas, eps_fusions, gss_tol, conv_tol, max_iter, store_all_res, verbose)
}
